...
//                new ViewModelProvider(this).get(HomeViewModel.class);
    ...
    private List<PhoTo> getListPhoto(){
        ...
        listPhotos.add(new PhoTo(R.drawable.b44));
        listPhotos.add(new PhoTo(R.drawable.b33));
        listPhotos.add(new PhoTo(R.drawable.m44));
        listPhotos.add(new PhoTo(R.drawable.h55));
        listPhotos.add(new PhoTo(R.drawable.m66));
