...
//        sms.setText(String.valueOf(data.getSmall()));
        ...
        if (data.getKind().getTotal() == 0) {
            pieChart_user_dt.addPieSlice(new PieModel("No data", 0, Color.parseColor("#FFA739")));
        } else {
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Yellow Leaf Curl Virus",
                            data.getKind().getYellowLeafCurlVirus(),
                            Color.parseColor("#FFFFA726")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Early_Blight",
                            data.getKind().getEarlyBlight(),
                            Color.parseColor("#FFEF5350")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Healthy",
                            data.getKind().getHealthy(),
                            Color.parseColor("#FF66BB6A")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Spider Mites",
                            data.getKind().getSpiderMites(),
                            Color.parseColor("#FF000000")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Septoria",
                            data.getKind().getSeptoria(),
                            Color.parseColor("#FFE3E0E0")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Mosaic Virus",
                            data.getKind().getMosaicVirus(),
                            Color.parseColor("#FF018786")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Leaf Mold",
                            data.getKind().getLeafMold(),
                            Color.parseColor("#FFBB86FC")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Leaf Miner",
                            data.getKind().getLeafMiner(),
                            Color.parseColor("#FF6200EE")));
            pieChart_user_dt.addPieSlice(
                    new PieModel(
                            "Late Blight",
                            data.getKind().getLateBlight(),
